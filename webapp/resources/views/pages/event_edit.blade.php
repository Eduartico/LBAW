...
<div class="container">
    ...
    <div class="row profile justify-content-center">
        ...
        <div id="edit-event" class="col-lg-10 push-lg-4">
            ...
            <h3 style="margin-bottom: 1.5rem; font-weight: 900;">Edit your event</h3>

            <hr>

            <form id="event-settings-form" data-id={{$event->id}} method="POST" enctype="multipart/form-data" action="{{"/event/".$event->id."/edit"}}">
                {{ csrf_field() }}
                ...
                <div>
                    <div>
                        ...
                        <input id="event-location" class="form-control form-control-sm" name="address" type="text" placeholder="{{$event->location->adress}}">
                        <div id="map"></div>
                ...
                <button id="button-save-changes" type="submit" class="btn"> UPDATE </button>
